    ...
    <main id={styles.LandingPage}>
      ...
      <section className={styles.getStarted}>
        <Container>
          ...
          <ListingContainer icon={ListingIcon} title="Create Your Listing"
          ...
          {/* Get Smart Matched  */}
          <ListingContainer icon={GetSmartedIcon} title="Get Smart Matched"
          ...
          {/* Pick a Winner  */}
          <ListingContainer icon={PickWinnerIcon} title="Pick a Winner"
          ...
          {/* Get Paid  */}
          <ListingContainer icon={GetPaidIcon} title="Get Paid"
      ...
      <section>
        <Container>
          ...
          and marketing for selling your home!" />
            ...
            <div className="mt-3">
              <AgentTestimonial avatar={AvatarBillieAnn} name="Billie Ann Figura" city="Myrtle Beach, SC"
            ...
            <div className="mt-3">
              <AgentTestimonial avatar={AvatarSteveDavis} name="Steven Davis" city="Beverly Hills, CA"
